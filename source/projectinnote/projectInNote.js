...
class linkedProject extends HTMLElement {
  ...
  /**
   * Creates a task list for project in the note
   * @param {Element} taskListElement task list element in HTML
   * @param {Array<String>} taskListArray array for task list of project
   * @param {String} projectID ID of project
   * @param {Element} progressBar progressBar element
   * @param {Element} progressLabel label for progressBar of % completed
   */
  ...
  /**
   * Event listener for changing task completion and updating progress bar
   * @param {Element} singleInputCheckbox checkbox for task
   * @param {String} projectID ID of project
   * @param {Element} progressBar progressBar element
   * @param {Element} progressLabel label for progress bar
  ...
  /**
   * Calculate the percentage of tasks completed for a project
   * @param {String} projectID ID of project
   * @returns 
   */
  ...
  /**
   * Format date to string form ex. June 9th
  ...
  /**
   * Returns formatted string for time till deadline
   * @param {String} deadline deadline of project
   * @returns formatted string for time till deadline
   */
